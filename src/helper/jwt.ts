...
import { ExpiresIn } from 'aws-sdk/clients/workmail'
...
export const generateToken = (payload: any, expiresIn: string = '10m') => {
    return jwt.sign(payload, jwt_token_secret, { expiresIn });
};

export const generateLoginToken =(payload:any,expiresIn:string = '7d') =>{
     return jwt.sign(payload, jwt_token_secret, { expiresIn });
}
